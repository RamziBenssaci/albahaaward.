...
class ImageRepository
{
    ...
    private $full_save_path_file = 'app/uploads/images';
    ...
    public function createUniqueFilename2( $filename, $extension ) {
        $path = storage_path($this->full_save_path_file . $filename . '.' . $extension);
