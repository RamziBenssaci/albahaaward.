    ...
    <div
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-2 p-md-10 pb-lg-20">
            ...
            <div class="w-sm-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto sign-box">
                <!--begin::Form-->
                <form class="form w-100" method="POST" action="<?php echo e(route('register')); ?>">
                    <?php echo csrf_field(); ?>
                    <!--begin::Heading-->
...
<?php /**PATH C:\wamp64\bin\apache\apache2.4.54.2\htdocs\MultiAuth\resources\views/auth/register.blade.php ENDPATH**/ ?>