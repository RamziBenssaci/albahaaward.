            ...
            <div class="w-sm-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto sign-box">
                ...
                <form class="form w-100" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">انشاء حساب</h1>
                        <p class="login-text">
                            لوحة تحكم <span class="fw-semibold">
                                جائزة مكه لتميز
                                    </span>
                        </p>
                        <!--end::Title-->
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <input class="form-control form-control-lg form-control-solid" type="text" name="name"
                               placeholder="الاسم" value="" autocomplete="off"/>
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Wrapper-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid" type="password" name="password_confirmation" id="password_confirmation" placeholder="تأكيد كلمة المرور"
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" class="btn btn-lg btn-primary w-100 mb-5">
                            <span class="indicator-label">انشاء حساب جديد</span>
                        </button>
                        <!--end::Submit button-->
                        <!--begin::Separator-->
