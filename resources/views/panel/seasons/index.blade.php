            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="categoryFormCreate">
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="fw-bold fs-6 mb-2"> اسم الموسم </label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary create_category"
                            data-url="{{ url('dashboard/seasons') }}" data-form="#categoryFormCreate">
                        اضافة
                    </button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary update_category"
                            data-url="{{ url('dashboard/seasons') }}" id="updateCategoryButton"
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('season.datatable') }}";
        window.create = "{{ route('seasons.create') }}";
    </script>
    <script src="{{ vAsset('assets/panel/js/tabels/seasons.js') }}"></script>
    ...
    <script>
        ...
        $(document).on("change", ".form-check-input", function (e) {
            ...
            var url = "{{ url('dashboard/disableSeasons') }}";
            var id = $(this).data('id');
            var data = {
