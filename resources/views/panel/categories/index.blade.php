            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="categoryFormCreate">
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="fw-bold fs-6 mb-2"> اسم التصنيف </label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary create_category"
                            data-url="{{ url('dashboard/categories') }}" data-form="#categoryFormCreate">
                        اضافة
                    </button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary update_category"
                            data-url="{{ url('dashboard/categories') }}" id="updateCategoryButton"
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('category.datatable') }}";
        window.create = "{{ route('categories.create') }}";
    </script>
    <script src="{{ vAsset('assets/panel/js/tabels/categories.js') }}"></script>
    ...
    <script>
        ...
        $(document).on("click", ".edit_category", function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#categoryForm input[type="text"]').val(categoryName);
        ...
        $(document).on("change", ".form-check-input", function (e) {
            ...
            var url = "{{ url('dashboard/disableCategories') }}";
            var id = $(this).data('id');
            var data = {
