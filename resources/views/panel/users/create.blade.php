    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">اضافه متقدم</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
            ...
            <textarea type="text" name="cv_description"
                      class="form-control form-control-lg form-control-solid"
                      placeholder="السيرة الذاتية المختصرة"></textarea>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">خفظ البيانات
                                </button>
                            </div>
                            <!--end::Actions-->
                        </form>
