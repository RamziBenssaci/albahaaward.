                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-title m-0">
                                    <h3 class="fw-bolder">
                                        تقديم طلب على جائزة
                                        - {{\App\Models\Contest::query()->find(Cache::get('contest'))->category->name}}
                                    </h3>
                                </div>
                                <!--end::Card title-->
                            </div>
...
{{--                                        </div>--}}
                                        <div class="col-lg-6 mb-5">
                                            ...
                                            <input type="text" class="form-control" name="fromـnomination"
                                                   placeholder="اسم الشخص ، المؤسسة، او الجهة المراد ترشيحها">
                                        ...
                                        <div class="col-lg-6 mb-5">
                                            ...
                                            <input type="text" class="form-control" name="project_title"
                                                   placeholder="يتكون من 50 حرف على الاكثر">
                                            <div class="error-message" style="color: red"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-5">
                                            <label class="form-label fw-bolder mb-4">مرفق المشروع</label>
